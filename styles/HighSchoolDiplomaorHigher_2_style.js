...
var style_HighSchoolDiplomaorHigher_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("HS >=");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 80.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 95.000000 && value <= 100.000000) {
            style = [ new ol.style.Style({
